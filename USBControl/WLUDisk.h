...
public:
    ...
    BOOL GetDeviceFullInfo(HDEVINFO hDevInfo, PSP_DEVINFO_DATA pDeviceInfoData, vector<boost::shared_ptr<DeviceInfoFull>>& VectAllDevice, vector<DevPathAndDevInst>& vectHubPathAndDevinst);
