...
std::shared_ptr<std::unordered_map<USHORT, std::string>> GetUSBVendorIDs() {
    auto USBVendorIDs = std::make_shared<std::unordered_map<USHORT, std::string>>(std::unordered_map<USHORT, std::string>{{0x0079, "Shenzhen Longshengwei Technology, Co., Ltd."},
