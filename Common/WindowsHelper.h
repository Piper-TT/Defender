...
public:
    ...
    static BOOL QueryServiceInfoByName(const tstring& strSrvName, DWORD& dwCurrentState, DWORD& dwStartType, tstring* pStrErr,
                                       DWORD* pLastErrCode = NULL, tstring* pStrServiceDisplayName = NULL);
};
