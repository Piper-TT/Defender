...
BOOL PECacheHelper::PE_CACHE_Init() {
    ...
    PE_CACHE_Init_Internal(&l_PECacheData.lookupTB, __PeCacheValue, __PeCacheRelease, __ComparePeCache, __hashCalc, sizeof(PE_CACHE_ITEM_KEY*), HASHTYPE_WLPECACHE);
...
BOOL PECacheHelper::PE_CACHE_Init_Internal(HASHTB* table, HAHSTB_VALUE __getValuePtr, HAHSTB_RELEASE release_item, HAHSTB_COMPARE compare_item, HAHSTB_Calc hash_calc, unsigned int valueLen,
                                           UCHAR type) {
...
********************************************************/
BOOL PECacheHelper::PE_CACHE_Query_Cache(IN std::wstring FilePath, IN ULONGLONG FileSize, IN ULONGLONG LastWriteTime, OUT PBOOLEAN IsMatch, OUT unsigned char* pWhiteListFileHash,
                                         OUT DWORD* InsertTimeDif) {
    BOOL           bRet        = TRUE;
